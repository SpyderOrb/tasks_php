            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    $items = [
                        [
                            "headers"  => "Privacy",
                            "articles" => "Your privacy is important to us at SmartAdmin and the protection, confidentiality and integrity of your personal data are our prime concerns.
...
",
                    ...
                    <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                        ...
                        foreach ($items as $item): ?>
                            <h2><?php
                                echo $item["headers"]; ?></h2>
                            <p><?php
                                echo $item["articles"]; ?></p>
                        <?php
                        endforeach; ?>
                    </div>
                </div>
